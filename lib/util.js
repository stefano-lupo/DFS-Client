...
export let FILES_DIR = path.join(`${__dirname}, /../remoteFiles/`);
export let CLIENT_KEY_LOCATION = `${__dirname}/clientKey.txt`;
...
//TODO: make this generic by passing it callbacks
